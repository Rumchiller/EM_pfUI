pfUI:RegisterModule("gui", 20400, function ()
  ...
  do -- Generate Config UI
    ...
    CreateGUIEntry(T["Minimap"], T["Minimap"], function()
      CreateConfig(nil, T["Enable Zone Text On Minimap"], C.appearance.minimap, "mouseoverzone", "checkbox")
	  ...
	  CreateConfig(nil, T["Show Zone And Coords Only On Mouseover"], C.appearance.minimap, "onlyonmouseover", "checkbox")
